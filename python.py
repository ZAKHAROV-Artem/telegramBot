...
def lalala(message):
	...
	if message.chat.type == 'private':
		...
		if message.text == 'Instagram':
			bot.send_message(message.chat.id, 'Подпишись пожалуйста ) https://www.instagram.com/invites/contact/?i=1alkmmd1xv87c&utm_content=333qb43')
def get_weather(message):
	...
	bot.send_message(message.chat.id, 'В городе ' + place + ' сейчас температура ' + str(temperature) + ' градуса по цельсию')
# RUN
